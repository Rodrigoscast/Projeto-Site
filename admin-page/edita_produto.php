...
$result = mysqli_fetch_array($executa);
    ...
    <div class="back">
        ...
        <div class="page_center">
            ...
            <div class="corpo_pagina">
                <form action="./executa_arquivos/edita_produto.php?id=<?= $idproduto ?>" method="post" enctype="multipart/form-data">
                    <div class="central">
                        <div class="textos">
                            ...
                            <div class="line">
                                ...
                                <div class="adiciona_item">
                                <input type="text" name="valor" id="valorInput" value="<?= $valor ?>" required>
                                    <label for="valor">Valor (R$)</label>
                                </div>
                            </div>
                            <div class="adiciona_item">
                                <textarea name="descricao" rows="4"><?= $descricao ?></textarea>
